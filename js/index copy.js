...
var vueObj = new Vue({
  ...
  methods: {
    ...
    getResourceType() {
      $.ajax({
        url: "http://kaizhou.1352.site.veeteam.com/home/main_label",
        success: res => {
    ...
    getBusinessEntity(type, businessEntityID) {
      $.ajax({
        url: "http://kaizhou.1352.site.veeteam.com/home/management_body/" + businessEntityID,
        success: res => {
    ...
    pointHeatMapData(type, id) {
      this.getBusinessEntity(type, id);
      this.zoomLevel = map.getZoom();
